          ...
          ElevatedButton(
            onPressed: () {
              if (regController.text.isNotEmpty &&
                ...
                _firestoreService.addStudent(widget.module.id, newStudent);
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              _firestoreService.updateStudent(widget.module.id, student);
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              _firestoreService.deleteStudent(widget.module.id, student.id);
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Student>>(
        ...
        builder: (context, snapshot) {
          ...
          if (students.isEmpty) return Center(child: Text("No students found. Add one!"));
